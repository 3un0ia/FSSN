...
const (
	Bidirectional_GetServerResponse_FullMethodName = "/bidirectional.Bidirectional/GetServerResponse"
)
...
type BidirectionalClient interface {
	...
	GetServerResponse(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Message, Message], error)
}
...
func (c *bidirectionalClient) GetServerResponse(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Message, Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Bidirectional_ServiceDesc.Streams[0], Bidirectional_GetServerResponse_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Bidirectional_GetServerResponseClient = grpc.BidiStreamingClient[Message, Message]
...
type BidirectionalServer interface {
	...
	//
	// Accepts a stream of Message sent while a route is being traversed,
	GetServerResponse(grpc.BidiStreamingServer[Message, Message]) error
	mustEmbedUnimplementedBidirectionalServer()
}

// UnimplementedBidirectionalServer must be embedded to have
...
func (UnimplementedBidirectionalServer) GetServerResponse(grpc.BidiStreamingServer[Message, Message]) error {
...
func (UnimplementedBidirectionalServer) testEmbeddedByValue()                       {}
...
func RegisterBidirectionalServer(s grpc.ServiceRegistrar, srv BidirectionalServer) {
	// If the following call pancis, it indicates UnimplementedBidirectionalServer was
...
func _Bidirectional_GetServerResponse_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BidirectionalServer).GetServerResponse(&grpc.GenericServerStream[Message, Message]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Bidirectional_GetServerResponseServer = grpc.BidiStreamingServer[Message, Message]
...
var Bidirectional_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bidirectional.Bidirectional",
